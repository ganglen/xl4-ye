...
import static com.xl4.netconf.anc.Netconf.*;
...
public class NetconfSession implements AutoCloseable {
    ...
    private XMLElement get(Datastore datastore, Consumer<XMLElement> filter, String command)
            throws NetconfException {
        // return call(new XMLElement(NS_NETCONF, datastore != null ? "get-config" : "get", gc -> {
        return call(new XMLElement(NS_NETCONF, command, gc -> {
                if (datastore != null && command.equals("get-config")) {
     ...
     */
    public XMLElement getConfig(Datastore datastore, String xpathFilter, String command) throws NetconfException {
        return get(datastore, f -> f
                .withAttribute("type", "xpath")
                .withAttribute("select", xpathFilter), command);
    }
     ...
     * @throws NetconfException RPCException or Protocol
     */
    public XMLElement getConfig(Datastore datastore, Iterable<XMLElement> subtreeFilter, String command) throws NetconfException {
        return get(datastore, f -> f
                .withAttribute("type", "subtree")
                .withChildren(subtreeFilter), command);
    }
     ...
     * @throws NetconfException RPCException or Protocol
     */
    public XMLElement getConfig(Datastore datastore, String command) throws NetconfException {
        return get(datastore, null, command);
    }
    ...
    public XMLElement get(String xpathFilter) throws NetconfException {
        return get(null, f -> f
                .withAttribute("type", "xpath")
                .withAttribute("select", xpathFilter), "get");
    }
    ...
    public XMLElement get(Iterable<XMLElement> subtreeFilter) throws NetconfException {
        return get(null, f -> f
                .withAttribute("type", "subtree")
                .withChildren(subtreeFilter), "get");
    }
