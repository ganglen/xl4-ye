...
import com.xl4.netconf.grpc.GNMI.Encoding;
import com.xl4.netconf.grpc.GNMI.Notification;
import com.xl4.netconf.grpc.GNMI.Path;
import com.xl4.netconf.grpc.GNMI.PathElem;
import com.xl4.netconf.grpc.GNMI.SubscribeRequest;
import com.xl4.netconf.grpc.GNMI.SubscribeResponse;
import com.xl4.netconf.grpc.GNMI.Subscription;
import com.xl4.netconf.grpc.GNMI.SubscriptionList;
import com.xl4.netconf.grpc.GNMI.SubscriptionMode;
import com.xl4.netconf.grpc.GNMI.SubscribeResponse.ResponseCase;
import com.xl4.netconf.grpc.GNMI.SubscriptionList.Mode;
import com.xl4.netconf.grpc.XRGRPC.CreateSubsArgs;
import com.xl4.netconf.grpc.XRGRPC.CreateSubsReply;
import com.xl4.netconf.grpc.gNMIGrpc.gNMIStub;
import com.xl4.netconf.grpc.gRPCConfigOperGrpc.gRPCConfigOperStub;
