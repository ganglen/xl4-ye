...
public final class gRPCExecGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs,
      com.xl4.netconf.grpc.XRGRPC.ShowCmdTextReply> METHOD_SHOW_CMD_TEXT_OUTPUT =
      io.grpc.MethodDescriptor.<com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs, com.xl4.netconf.grpc.XRGRPC.ShowCmdTextReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "IOSXRExtensibleManagabilityService.gRPCExec", "ShowCmdTextOutput"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.xl4.netconf.grpc.XRGRPC.ShowCmdTextReply.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs,
      com.xl4.netconf.grpc.XRGRPC.ShowCmdJSONReply> METHOD_SHOW_CMD_JSONOUTPUT =
      io.grpc.MethodDescriptor.<com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs, com.xl4.netconf.grpc.XRGRPC.ShowCmdJSONReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
          .setFullMethodName(generateFullMethodName(
          ...
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.xl4.netconf.grpc.XRGRPC.ShowCmdJSONReply.getDefaultInstance()))
          .build();
  ...
  public static abstract class gRPCExecImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void showCmdTextOutput(com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs request,
        io.grpc.stub.StreamObserver<com.xl4.netconf.grpc.XRGRPC.ShowCmdTextReply> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_SHOW_CMD_TEXT_OUTPUT, responseObserver);
    }

    /**
     */
    public void showCmdJSONOutput(com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs request,
        io.grpc.stub.StreamObserver<com.xl4.netconf.grpc.XRGRPC.ShowCmdJSONReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs,
                com.xl4.netconf.grpc.XRGRPC.ShowCmdTextReply>(
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs,
                com.xl4.netconf.grpc.XRGRPC.ShowCmdJSONReply>(
  ...
  public static final class gRPCExecBlockingStub extends io.grpc.stub.AbstractStub<gRPCExecBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<com.xl4.netconf.grpc.XRGRPC.ShowCmdTextReply> showCmdTextOutput(
        com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs request) {
    ...
    /**
     */
    public java.util.Iterator<com.xl4.netconf.grpc.XRGRPC.ShowCmdJSONReply> showCmdJSONOutput(
        com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs request) {
      return blockingServerStreamingCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SHOW_CMD_TEXT_OUTPUT:
          serviceImpl.showCmdTextOutput((com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs) request,
              (io.grpc.stub.StreamObserver<com.xl4.netconf.grpc.XRGRPC.ShowCmdTextReply>) responseObserver);
          break;
        case METHODID_SHOW_CMD_JSONOUTPUT:
          serviceImpl.showCmdJSONOutput((com.xl4.netconf.grpc.XRGRPC.ShowCmdArgs) request,
              (io.grpc.stub.StreamObserver<com.xl4.netconf.grpc.XRGRPC.ShowCmdJSONReply>) responseObserver);
          break;
        default:
